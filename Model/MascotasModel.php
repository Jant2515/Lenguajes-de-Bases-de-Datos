...
function EditarMascotaModel($IDMas, $NomMas, $RazaMas, $EdadMas, $PesoMas, $TallaMas, $GeneroMas, $EsterilizadoMas, $PedigreeMas, $IdCliente)
{
    require_once('ConnBD.php');
    $conex = new Conexion();

    $getConection = $conex->Conectar();
    $sentencia = $getConection->prepare("BEGIN INSERTAR_MASCOTA(:VIDMASCOTA, :VNOMBRE_MASC, :VRAZA_MASC, :VEDAD_MASC, :VPESO_MASC, :VTALLA_MASC, :VGENERO_MASC, :VESTERELIZADO_MASC, :VPEDIGREE_MASC, :VIDCLIENTE); END;");
