...
function EditarClienteModel($IDCli, $NombreCli, $ApellidoCli, $TelefonoCli, $EmailCli, $CedulaCli, $ProvinciaCli, $CantonCli, $DistritoCli)
{
    require_once('ConnBD.php');
    $conex = new Conexion();

    $getConection = $conex->Conectar();
    $sentencia = $getConection->prepare("BEGIN EDITAR_CLIENTE(:VIDCLIENTE, :VNOMBRECLIENTE, :VAPELLIDOCLIENTE, :VTELEFONOCLIENTE, :VEMAILCLIENTE, :VCEDULA, :VIDPROVINCIA, :VIDCANTON, :VIDDISTRITO); END;");
